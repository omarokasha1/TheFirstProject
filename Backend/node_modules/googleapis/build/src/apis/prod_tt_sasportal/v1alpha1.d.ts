...
export declare namespace prod_tt_sasportal_v1alpha1 {
    ...
    export class Resource$Customers {
         ...
         */
        create(params: Params$Resource$Customers$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Customers$Create, options?: MethodOptions): GaxiosPromise<Schema$SasPortalCustomer>;
        create(params: Params$Resource$Customers$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Customers$Create, options: MethodOptions | BodyResponseCallback<Schema$SasPortalCustomer>, callback: BodyResponseCallback<Schema$SasPortalCustomer>): void;
        create(params: Params$Resource$Customers$Create, callback: BodyResponseCallback<Schema$SasPortalCustomer>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Customers$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Customers$Delete, options?: MethodOptions): GaxiosPromise<Schema$SasPortalEmpty>;
        delete(params: Params$Resource$Customers$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Customers$Delete, options: MethodOptions | BodyResponseCallback<Schema$SasPortalEmpty>, callback: BodyResponseCallback<Schema$SasPortalEmpty>): void;
        delete(params: Params$Resource$Customers$Delete, callback: BodyResponseCallback<Schema$SasPortalEmpty>): void;
