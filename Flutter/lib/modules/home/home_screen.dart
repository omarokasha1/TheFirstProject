...
import '../my_learning/my_learning_cubit/cubit.dart';
...
//Test
Widget buildUserTracksItem(context, bool enroll, Tracks tracksModel) => InkWell(
      onTap: () {
        navigator(
            context,
            enroll
